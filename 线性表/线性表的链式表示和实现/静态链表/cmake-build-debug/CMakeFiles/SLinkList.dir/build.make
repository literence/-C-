...
CMAKE_SOURCE_DIR = "/home/li/CLionProjects/数据结构(C语言版)/线性表/线性表的链式表示和实现/静态链表"

# The top-level build directory on which CMake was run.
CMAKE_BINARY_DIR = "/home/li/CLionProjects/数据结构(C语言版)/线性表/线性表的链式表示和实现/静态链表/cmake-build-debug"
...
CMakeFiles/SLinkList.dir/SLinkList.c.o: ../SLinkList.c
	@$(CMAKE_COMMAND) -E cmake_echo_color --switch=$(COLOR) --green --progress-dir="/home/li/CLionProjects/数据结构(C语言版)/线性表/线性表的链式表示和实现/静态链表/cmake-build-debug/CMakeFiles" --progress-num=$(CMAKE_PROGRESS_1) "Building C object CMakeFiles/SLinkList.dir/SLinkList.c.o"
	/usr/bin/cc $(C_DEFINES) $(C_INCLUDES) $(C_FLAGS) -o CMakeFiles/SLinkList.dir/SLinkList.c.o   -c "/home/li/CLionProjects/数据结构(C语言版)/线性表/线性表的链式表示和实现/静态链表/SLinkList.c"
...
CMakeFiles/SLinkList.dir/SLinkList.c.i: cmake_force
	...
	/usr/bin/cc $(C_DEFINES) $(C_INCLUDES) $(C_FLAGS) -E "/home/li/CLionProjects/数据结构(C语言版)/线性表/线性表的链式表示和实现/静态链表/SLinkList.c" > CMakeFiles/SLinkList.dir/SLinkList.c.i
...
CMakeFiles/SLinkList.dir/SLinkList.c.s: cmake_force
	...
	/usr/bin/cc $(C_DEFINES) $(C_INCLUDES) $(C_FLAGS) -S "/home/li/CLionProjects/数据结构(C语言版)/线性表/线性表的链式表示和实现/静态链表/SLinkList.c" -o CMakeFiles/SLinkList.dir/SLinkList.c.s
...
SLinkList: CMakeFiles/SLinkList.dir/link.txt
	@$(CMAKE_COMMAND) -E cmake_echo_color --switch=$(COLOR) --green --bold --progress-dir="/home/li/CLionProjects/数据结构(C语言版)/线性表/线性表的链式表示和实现/静态链表/cmake-build-debug/CMakeFiles" --progress-num=$(CMAKE_PROGRESS_2) "Linking C executable SLinkList"
...
CMakeFiles/SLinkList.dir/depend:
	cd "/home/li/CLionProjects/数据结构(C语言版)/线性表/线性表的链式表示和实现/静态链表/cmake-build-debug" && $(CMAKE_COMMAND) -E cmake_depends "Unix Makefiles" "/home/li/CLionProjects/数据结构(C语言版)/线性表/线性表的链式表示和实现/静态链表" "/home/li/CLionProjects/数据结构(C语言版)/线性表/线性表的链式表示和实现/静态链表" "/home/li/CLionProjects/数据结构(C语言版)/线性表/线性表的链式表示和实现/静态链表/cmake-build-debug" "/home/li/CLionProjects/数据结构(C语言版)/线性表/线性表的链式表示和实现/静态链表/cmake-build-debug" "/home/li/CLionProjects/数据结构(C语言版)/线性表/线性表的链式表示和实现/静态链表/cmake-build-debug/CMakeFiles/SLinkList.dir/DependInfo.cmake" --color=$(COLOR)
